...
the version before ~window-chord-helper~.  I've also added [[https://github.com/arthurgleckler/cosmic-chord.git][COSMIC
Chord]], the COSMIC-specific equivalent to ~launch-or-select~.)